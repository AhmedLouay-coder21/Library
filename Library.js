...
class library
{
  ...
  displayBookInfo(i)
  {
      ...
      this.books[i].isRead = prompt("Please enter the new status", "Yes/No/Intend To/in 1 week");
        isRead.textContent = this.books[i].isRead;
...
form.addEventListener("submit", function(event) {
  ...
  myLibrary.addBookToLibrary(formTitle,formAuthor,formPages,formIsRead);
